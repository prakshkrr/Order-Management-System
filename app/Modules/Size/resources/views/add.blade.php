...
<div class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  <strong></strong> You successfully add your size.
</div> 
@endif  
{{-- session --}}
<style>
...
<div class="card card-primary">
  ...
  <div class="card-body">
    <div class="d-flex justify-content-end">
      ...
      <form action="{{ route('size.add') }}" method="post" id="form">
        {!! csrf_field() !!}
           
        <div class="form-group pb-3">
          <label for="category_name">size name<span class="text-danger">*</span></label>
