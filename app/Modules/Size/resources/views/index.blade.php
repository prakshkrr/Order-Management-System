    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="form-group text-right">
                <a href="{{ route('size.add') }}" class="btn btn-outline-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
            </div>
            <!-- /.card-header -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <a href="{{ url('/admin/size/edit',[$col->id]) }}" class="editdata" name="{{ $col->name }}"
                                        data-id="{{ $col->id }}"><i
                                            class="far fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="{{ route('size.index') }}" class="delete"
